...
const SideBarMenu = () => {
        ...
        API.get('budgets/list')
            .then((response) => {
                setState({
                    ...state,
                    status: "loaded",
                    budgets: response.data.sort((a, b) => {
    ...
    return (
        <nav id="sidebarMenu" className="compSideBarMenu col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
            <div className="position-sticky pt-3 sidebar-sticky">
                <ul className="nav flex-column">
                    <li className="nav-item">
                        <Link className="nav-link" aria-current="page" to="/app/budgets">
                    ...
                    <li className="nav-item">
                        <Link className="nav-link" aria-current="page" to="/app/sharedbudgets">
                    ...
                    <li className="nav-item">
                        <Link className="nav-link" aria-current="page" to="/app/bin">
                ...
                <ul className="nav flex-column mb-2">
                    {state.budgets.map((element, index) => {
                        if (index < 6) {
                            return (
                                <li className="nav-item">
                                    <Link className="nav-link" aria-current="page" to={`/app/decomp/folders/${element.ID}`}>
